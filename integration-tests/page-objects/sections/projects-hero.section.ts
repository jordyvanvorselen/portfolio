...
export class ProjectsHero extends BaseSection {
  ...
  readonly description: Locator = this.section.getByText(
    /A collection of my open-source software projects/i
  )
  readonly projectsCount: Locator = this.section.getByText('3')
  readonly starsCount: Locator = this.section.getByText('67')
  readonly forksCount: Locator = this.section.getByText('9')
}
