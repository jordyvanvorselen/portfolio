...
describe('ContentfulImage', () => {
  describe('contentfulLoader', () => {
    it('generates URL with width and default quality', () => {
      ...
      expect(result).toBe('https://images.ctfassets.net/test/image.jpg?w=800&q=75')
    })
    ...
    it('generates URL with custom quality', () => {
      ...
      expect(result).toBe('https://images.ctfassets.net/test/image.jpg?w=400&q=90')
    })
    ...
    it('handles quality of 0', () => {
      ...
      expect(result).toBe('https://images.ctfassets.net/test/image.jpg?w=600&q=75')
    })
    ...
    it('generates URL with different width values', () => {
      ...
      expect(result).toBe('https://images.ctfassets.net/test/image.jpg?w=1200&q=100')
    })
